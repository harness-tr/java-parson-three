...
```
app/src/main/java/com/java-parson-three/HelloController.java
```
...
**Important:** Replace the image placeholder `gcr.io/YOUR_PROJECT_ID/java-parson-three:latest` with your actual GCR or Artifact Registry path.
